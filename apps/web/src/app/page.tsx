      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p className="hero-text">
            Six information-theoretic strategies evaluated across standard,
            adversarial, and latent-mode Wordle environments. Play games,
            replay solver traces, and compare behavioral profiles.
          </p>
